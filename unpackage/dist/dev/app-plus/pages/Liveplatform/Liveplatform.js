...
var _default = { data: function data() {return { height: 0, width: 0, direction: 0, statusheight: 0, bottomheight: 0, //临时的路径
      url: "" };}, methods: {}, components: { liveleft: _lineleft.default, livemidden: _livemidden.default, liveright: _liveright.default }, created: function created() {var _this = this;uni.getSystemInfo({ success: function success(res) {//获取手机宽度
  ...
  onLoad: function onLoad(opction) {var
    indexs = opction.indexs;
    this.url = "rtmp://49.232.153.178:1935/live/live0".concat(parseInt(indexs) + 1);
...
var _livechatlist = _interopRequireDefault(__webpack_require__(/*! ../liveplice/livechatlist.nvue */ 30));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} //
//
//
//
//
    ...
    reportqiehuan: function reportqiehuan(e) {e.stopPropagation();this.reportbool = false;}, xin: function xin() {var _this2 = this;this.xinurl = "/static/liveplatfrom/dianxinchecked.png";setTimeout(function () {_this2.xinurl = "/static/liveplatfrom/dianxin.png";}, 500);}, sharezhibo: function sharezhibo() {// uni.shareWithSystem({
      ...
      uni.share({
        ...
        success: function success(res) {
          __f__("log", res, "成功", " at components\\live\\livemidden.nvue:149");
        },
        fail: function fail(err) {
          __f__("log", err, "失败", " at components\\live\\livemidden.nvue:152");
        } });
